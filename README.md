...
- **Problem:** Wer ein Notenblatt vor sich hat, aber nicht weiss, wie die notierten Töne klingen sollen, steht vor einem grossen Problem – besonders beim Üben zu Hause. Ohne einen Chorleiter oder ein Instrument in der Nähe ist es für viele Menschen schlicht nicht möglich, sich den richtigen Ton vorzustellen. Ein typisches Beispiel: Jemand möchte ein neues Lied für den Chor einüben, sieht die Noten auf dem Papier, hat aber keine Ahnung, ob der Ton nun hoch oder tief ist. Genau hier setzt dieses Projekt an: Es spielt den gesuchten Ton direkt ab, sodass jede Person selbstständig und ohne fremde Hilfe üben kann.
- **Ziele:** Die Anwendung gibt auf Anfrage den korrekten Ton einer ausgewählten Note akustisch aus, sodass der Nutzer weiss, wie dieser klingen soll. Singende Personen können ohne die Hilfe eines Chorleiters oder eines Instruments eigenständig und ortsunabhängig üben. Die Anwendung ist einfach und intuitiv bedienbar, sodass auch Personen ohne musiktheoretische Vorkenntnisse damit umgehen können. Das Tool steht einer breiten Nutzergruppe zur Verfügung – von Choreinsteigern bis hin zu fortgeschrittenen Laien. Durch das Anhören des richtigen Tons vor dem Singen werden Intonationsfehler beim Üben minimiert.
- **Primäre Zielgruppe:** **Chormitglieder ohne Notenkenntnisse**, die neue Stücke zu Hause vorbereiten möchten, aber keinen Chorleiter zur Hand haben. **Gesangsanfänger**, die ein Instrument oder eine Begleitperson zum Üben benötigen würden, dies aber nicht immer organisieren können._  
- **Weitere Stakeholder:** **Hobbysingende**, die eigenständig üben und singen, profitieren davon. **Kinder und Jugendliche** können Noten spielerisch erlernen. **Chorleiter und Dirigenten** können das Tool weiterempfehlen als Übungshilfe. **Musikschulen oder Chörvereine** können das Tool selbst benutzen oder weiterempfehlen.  


## 2. Lösungsidee
Hier wird die Lösungsidee beschrieben.
